 ...
 */
class Product extends \CoreBundle\Entity\Product implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'CoreBundle\\Entity\\Product' . "\0" . 'id', '' . "\0" . 'CoreBundle\\Entity\\Product' . "\0" . 'name', '' . "\0" . 'CoreBundle\\Entity\\Product' . "\0" . 'price', '' . "\0" . 'CoreBundle\\Entity\\Product' . "\0" . 'qte', '' . "\0" . 'CoreBundle\\Entity\\Product' . "\0" . 'categorie', '' . "\0" . 'CoreBundle\\Entity\\Product' . "\0" . 'created', '' . "\0" . 'CoreBundle\\Entity\\Product' . "\0" . 'updated', '' . "\0" . 'CoreBundle\\Entity\\Product' . "\0" . 'slug', '' . "\0" . 'CoreBundle\\Entity\\Product' . "\0" . 'file', '' . "\0" . 'CoreBundle\\Entity\\Product' . "\0" . 'fullPath'];
        }
     ...
     * {@inheritDoc}
     */
    public function setCategorie(\CoreBundle\Entity\Category $categorie = NULL)
    {
